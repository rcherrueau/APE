...
-- Function and data types must be defined befor use, since dependent
-- types allow function to appear as part of types, and their
-- reduction behaviour to affect type checking. However this
-- restriction can be relaxed using a `mutual` block.
